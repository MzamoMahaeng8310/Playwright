...
const loginPayLoad =   {userEmail:"tamia.tamara@gmail.com",userPassword:"Password123"};
...
// Video 44: how to intecept network srequest  call with praywright
...
//   button[routerlink*='/dashboard/myorders']
 // then we mock here for the request before clicking view 

 await page.route("https://rahulshettyacademy.com/api/ecom/order/get-orders-details?id=6446dbf4568c3e9fb15b4c54",

  route=> route.continue({url: 'https://rahulshettyacademy.com/api/ecom/order/get-orders-details?id=64451376568c3e9fb159f85d'}) // provide url where orders are not part of this account. 
...
await page.locator("button:has-text('View')").first().click();  // click on the first view button as there are many
await page.pause();
